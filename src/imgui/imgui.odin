...
Key :: enum c.int { // Forward declared enum type ImGuiKey
  ...
  NamedKey_COUNT = 154,
  COUNT = 666,              // Obsoleted in 1.91.5 because it was extremely misleading (since named keys don't start at 0 anymore)
...
Font :: struct {
  ...
  ConfigDataCount:     c.short,     // 2     // in  // Number of ImFontConfig involved in creating this font. Usually 1, or >1 when merging multiple font sources into one ImFont.
