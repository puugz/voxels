...
ErrorCallback :: #type proc(ctx: ^Context, user_data: rawptr, msg: cstring)
...
foreign lib {
  ...
  @(link_name="ImGui_RenderNavCursor")                      RenderNavCursor                      :: proc(bb: Rect, id: ID, flags: NavRenderCursorFlags = NavRenderCursorFlags_ImGuiNavHighlightFlags_None)                                                                                     --- // Navigation highlight
  @(link_name="ImGui_RenderNavHighlight")                   RenderNavHighlight                   :: proc(bb: Rect, id: ID, flags: NavRenderCursorFlags = NavRenderCursorFlags_ImGuiNavHighlightFlags_None)                                                                                     --- // Renamed in 1.91.4
  ...
  @(link_name="cImFontAtlasBuildGetOversampleFactors")        cImFontAtlasBuildGetOversampleFactors      :: proc(cfg: ^FontConfig, out_oversample_h: ^c.int, out_oversample_v: ^c.int)                                                                    ---
